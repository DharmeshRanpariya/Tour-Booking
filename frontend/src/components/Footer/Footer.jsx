      ...
      <Container>
        <Row>
            ...
            <ListGroup className="footer_quick-links">
              <ListGroupItem className="ps-0 border-0 flex align-items-center gap-3 ">
                <h6 className="mb-0 d-flex align-items-center gap-2">
                  ...
                  Address:
                <p className="mb-0 ">Surat , India</p>
                </h6>
              </ListGroupItem>
              <ListGroupItem className="ps-0 border-0 flex align-items-center gap-3 ">
                <h6 className="mb-0 d-flex align-items-center gap-2">
              ...
              <ListGroupItem className="ps-0 border-0 flex align-items-center gap-3 ">
                <h6 className="mb-0 d-flex align-items-center gap-2">
                  ...
                  Phone:
                <p className="mb-0 ">+917383084769</p>
                </h6>
              </ListGroupItem>
            </ListGroup>
          </Col>
          ...
          <Col lg='12' className="text-center pt-5 ">
            <p className="copyright">Copyright {year} , design and develop by Ranpariya Dharmesh Surat. All rights reserved.</p>
          </Col>
        </Row>
      </Container>
    </footer>
